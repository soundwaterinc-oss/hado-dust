...
const TABS: ParamTab[] = ["PERFORM", "GEO", "FIELD", "GROOVE", "TEXTURE", "EVOLVE", "MUTATE", "IO", "INFO"];
const PARAM_TABS: ParamTab[] = ["GEO", "FIELD", "GROOVE", "TEXTURE", "EVOLVE", "MUTATE", "IO"];
...
export class DustUI {
  ...
  constructor(
    ...
    private seq: PulseSequencer, private hooks: UIHooks,
  ) {
    this.root = root;
    root.innerHTML = "";
    const left = div("left");
